...
public class JUnitPlatformTestFramework implements TestFramework {
    ...
    public WorkerTestClassProcessorFactory getProcessorFactory() {
        return new JUnitPlatformTestClassProcessorFactory();
    }
    ...
    public static class JUnitPlatformTestClassProcessorFactory implements WorkerTestClassProcessorFactory, Serializable {
        ...
        public TestClassProcessor create(ServiceRegistry serviceRegistry) {
            try {
                ...
                Constructor constructor = clazz.getConstructor(IdGenerator.class, Clock.class, ActorFactory.class);
                return (TestClassProcessor) constructor.newInstance(idGenerator, clock, actorFactory);
            } catch (Exception e) {
